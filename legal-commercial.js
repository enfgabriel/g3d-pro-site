(function () {
  ...
  function renderPublicPresentation() {
      ...
      <main class="public-shell">
        <header class="public-topbar">
          <div class="public-brand">
            ...
            <div><strong>G3D Pro</strong><span>ERP para impressão 3D</span></div>
          </div>
          ...
          <div class="public-hero-inner">
            <div>
              ...
              <div class="public-actions">
                <button class="btn primary" type="button" data-open-login>Entrar no sistema</button>
                <button class="btn" type="button" data-open-legal-public>Ver política e termos</button>
              </div>
            </div>
        ...
        <section class="public-section" id="plans">
          <div class="public-section-inner">
            ...
            <div class="public-plan-grid">
              ...
              <article class="public-plan featured"><strong>Produção comercial</strong><p class="muted">Domínio próprio, termos revisados, backups, suporte e ambiente mais robusto.</p></article>
        ...
        <section class="public-section">
          <div class="public-section-inner">
            <div class="public-grid">
              <article class="public-card"><h3>Contato e suporte</h3><p>Durante a fase de testes, o suporte é feito diretamente com o administrador do projeto. Antes da venda para terceiros, será definida uma rotina formal de atendimento.</p></article>
    ...
    document.querySelectorAll("[data-public-section]").forEach(button => button.addEventListener("click", () => {
      document.getElementById(button.dataset.publicSection)?.scrollIntoView({ behavior: "smooth", block: "start" });
    }));
  }
  ...
  function renderPublicLegalPage() {
    app.innerHTML = `
      <main class="public-shell">
        <header class="public-topbar">
          <div class="public-brand"><div class="logo">G3D</div><div><strong>G3D Pro</strong><span>Termos, privacidade e LGPD</span></div></div>
          <nav class="public-nav"><button class="btn" type="button" data-open-public>Apresentação</button><button class="btn primary" type="button" data-open-login>Entrar</button></nav>
        </header>
        <section class="public-section"><div class="public-section-inner">${legalContentHtml(true)}</div></section>
      </main>`;
  ...
  function renderLegalPage(el) {
    ...
    document.querySelectorAll("[data-legal-anchor]").forEach(button => button.addEventListener("click", () => {
      document.getElementById(button.dataset.legalAnchor)?.scrollIntoView({ behavior: "smooth", block: "start" });
    }));
  }
  ...
  function bootLegalPages() {
    if (state?.session) {
      ensureLegalPagesInMenu();
      const hasMenu = Boolean(document.querySelector('[data-page="legal"]'));
      if (!hasMenu) renderApp();
